program fortran_mpi
    ...
    call mycom%init(lx, ly, px, py, field_com_type_nonblock)
    ...
    mycom%left_ext_type = negb_ext_type_symmetry

    call mycom%com(array, field_com_opt_sum, 1, lx, 1, ly)
    call mycom%com(array_ext, field_com_opt_ext, 1, lx, 1, ly)
